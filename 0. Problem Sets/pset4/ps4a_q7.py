        ...
        try:
            for letter in word:
                if hand_copy[letter] > 0:
                    ...
                    return False
        except: # accounting for the possibility hand_copy[letter] doesn't exist
            return False
        else:
            return True
    return False
...
def playGame(wordList):
    ...
    while True:
        ...
        if user_input == "n" or user_input == "r":
            # If a new game is to be started, deal a new hand.
            if user_input == "n":
        ...
        # else, break out of playGame's loop and end the game
        elif user_input == "e":
            break
