...
Compared to my answer, they introduce an additional base case and don't
involve string indexing till later in the code.
'''
...
to test if char is in aStr. char will be a single character and aStr will be 
a string that is in alphabetical order. The function should return a boolean value.
